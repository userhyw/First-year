...
//------------------------------------------------------------------------------
//-----------------graphlink------------------------------------------------------------------
void visitLink(GraphLink &G, int verID)
{         //顶点编号从1开始，数组0单元不用
...
//***********************************************************//
int LocateVertexLink(GraphLink &G, elementType v)
{
...
//搜索顶点v的第一个邻接顶点
int firstAdjLink(GraphLink &G, int v)
{
	EdgeNode *p;
...
int nextAdjLink(GraphLink &G, int v, int w)
{
	EdgeNode *p;
...
//***********************************************************//
void printGraphLink(GraphLink &G)
{
	int i=0,j=0;
	//打印图的类型
	switch(G.gKind)
